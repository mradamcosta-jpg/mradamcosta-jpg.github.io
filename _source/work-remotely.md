...
![Since I chose to work remotely in 2009, I've lived in 32 countries (and counting).](Claude/Website/_source/images/image-11-700x360.png)By working remotely, I've been able to live in 32 countries (and counting).
...
![](Claude/Website/_source/images/image-700x607.png)
...
1. **It boosts productivity. **According to a Stanford study, working from home increases productivity equal to an extra day per week. ([Source](https://nbloom.people.stanford.edu/sites/g/files/sbiybj4746/f/wfh.pdf).)
2. **It reduces costs. **With fewer people in the office, employers can reduce or eliminate overhead costs such as real estate and operating expenses. The average savings? $11,000 a year per remote worker. ([Source](https://www.pgi.com/blog/2013/03/what-are-the-cost-savings-of-telecommuting/).)
3. **It's like giving you a raise—without writing a check.** The average remote worker saves about $7,000 a year (which is mainly from commuting, food, clothing, and child care). ([Source](https://www.tecla.io/blog/2019-remote-it-workers-stats-companies-should-know/).) So, by letting you work remotely, your employer is, in effect, paying you more. 
...
- [FlexJobs](https://www.flexjobs.com/jobs) has a list of remote and freelance positions.
...
- There is a list of additional resources [here](https://github.com/lukasz-madon/awesome-remote-job).
