---
title: "Chapter 13: Investment order"
date: "2018-11-17"
author: "adamcosta"
status: "publish"
...
- [Step 1: Create an emergency fund](#Create-an-emergency-fund).

- [Step 2: Max your 401(k) up to your company's match](#Max-your-401k-match). 

- [Step 3: Pay off your existing ](#Pay-off-your-existing-consumer-debts)*[consumer](#Pay-off-your-existing-consumer-debts)*[ debts](#Pay-off-your-existing-consumer-debts).

- [Step 4: Max your Health Savings Account](#Max-your-Health-Savings-Account) (HSA).

- [Step 5: Max your Individual Retirement Accounts](#Max-your-Individual-Retirement-Accounts) (IRA).

- [Step 6: Max your 401(k)](#Max-your-401k).

- [Step 7: Invest the remainder in a taxable account. ](#-Invest-the-remainder-in-a-taxable-account)
...
- **A money-market account;** [Vanguard Prime Money Market Fund](https://investor.vanguard.com/mutual-funds/profile/VMMXX) (VMMXX) is a good example. (Note: this is not insured, your principle is not guaranteed.)
...
**All you need to know:** Find out how much money your employer matches. Contribute that exact amount for now. You may contribute more when you get to [step 6](#Max-your-401k) below.
...
- *** Car loan -> Credit card -> Student loan***

So which option is right for you? **I recommend Option 1**—paying off the highest interest rate first—because it delivers a better return on investment.
...
- **You can contribute around $3,500 if single and $7,000 if married**, plus an extra $1,000 "catch up" contribution if you are over 55. (These are just estimates, however; use [this Google link](https://www.google.com/search?q=hsa+contributions+irs+this+year) to see current contribution limits.)
...
|  | Contribution  
(Money goes in) | Growth | Withdrawal  
(Money comes out) |
...
This one's pretty simple. In [step 3](#Max-your-401k-match) you funded your 401(k) to get the maximum matching dollars from your employer. In [step 5](#Max-your-Individual-Retirement-Accounts), you maxed out your IRA because an IRA gives you greater flexibility and lower fees than a 401(k). 

Now, put as much money as you can into your 401(k) to enjoy the tax breaks. Note: use [this Google link](https://www.google.com/search?q=current+limits+for+401(k)+contributions&oq=current+limits+for+401(k)+contributions) to see the current limits for 401(k) contributions.
