---
title: "Chapter 6: How to pay less tax—by having more fun"
date: "2018-11-17"
author: "adamcosta"
status: "publish"
...
![An image of flight departures. You'll be able to save money on taxes by traveling more.](Claude/Website/_source/images/image-12-700x464.png)Tax planning never looked better. (Source: [JESHOOTS.COM](https://unsplash.com/@jeshoots?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).)
...
- [Travel abroad (and save big) with the Foreign Earned Income Exclusion](#travel-abroad)
- [Move to a tax-friendly state](#tax-friendly-state)
- [Invest in state municipal bonds](#municipal)
- [401(k) accounts or 457 or 403(b)](#401k)
- [Individual Retirement Accounts (IRAs)](#iras)
- [Roth IRA](#roth)
- [Health Savings Account (HSA)](#hsa)
- [Other tax-reduction strategies](#other-strategies)
...
| **Annual household income** | **Tax savings if you move** |
| $62,000 | $1,500 |
| $124,000 | $8,000 |
| $200,000 | $12,000 |
| $300,000 | $21,000 |
...
| $1,500 | $22,253 | $890 |
| $8,000 | $118,685 | $4,747 |
| $12,000 | $178,028 | $7,121 |
| $21,000 | $311,549 | $12,461 |
...
If you want to go "full nomad"—and need an address for mail and proving residency, rather than a roof over your head—use a mail forwarding service like Escapees.com; they'll provide you with a physical address (necessary to get a driver's license). Plus, they open, scan, and email you digital copies of your mail. 
...
There is a limit to how you can contribute each year. You can see the current 401(k) maximum contribution [here](https://www.google.com/search?q=max+401k+contribution).
...
One caveat: **watch out for wash sales**. A *wash sale* is a sale of a security at a loss and repurchase of the same or substantially identical security shortly before or after. You can read more about wash sales [here](https://en.wikipedia.org/wiki/Wash_sale).
